...
class handDetector:
    def __init__(self, mode=False, maxHands=2, model_complexity=1, detectionCon=0.5, trackCon=0.5):
        ...
        self.results = None  # Store results globally
    ...
    def findHands(self, img, draw=True):
        ...
        return img  # Keeping return format consistent
    ...
    def fingersUp(self):
        ...
        if len(self.lmList) == 0:
            return fingers  # Return empty list if no hand is detected
...
def main():
    pTime = 0
    cap = cv2.VideoCapture(0)  # Use 0 to ensure compatibility
    ...
    while True:
        ...
        if lmList:
            print(lmList[4])  # Printing thumb tip coordinates
